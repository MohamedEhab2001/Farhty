          ...
          >
            ...
            <div className="space-y-12 text-[#8c7a87] leading-relaxed text-lg">
              ...
              <section className="bg-white p-8 rounded-2xl border border-[#ebdce3]/40 shadow-sm">
                ...
                <p>
                  "فرحتي" هي منصة توفر تصاميم دعوات زفاف إلكترونية تفاعلية. بعد الشراء، يحصل العميل على رابط مخصص لدعوته مع إمكانية تعديل البيانات والصور من خلال لوحة تحكم بسيطة.
                </p>
              </section>
