...
const FAQS = [
  ...
  { q: 'ما هي طرق الدفع المتاحة؟', a: 'نقبل الدفع عبر فودافون كاش على الرقم 01090033528 أو إنستاباي على الحساب ehab201nbe.' },
  ...
  { q: 'ما هي سياسة الاسترداد؟', a: 'نضمن استرداد المبلغ كاملاً خلال ٢٤ ساعة إذا لم تكن راضياً عن الخدمة لأي سبب.' },
  { q: 'كم تظل الدعوة متاحة؟', a: 'تظل دعوتك متاحة بشكل افتراضي لمدة ٦ أشهر من تاريخ الشراء، ويمكننا زيادة هذه المدة حسب رغبتك عند الطلب.' },
]
      ...
      <div className="container-luxe max-w-3xl">
        <Reveal className="text-center mb-14">
          ...
          <h2 className="text-4xl md:text-5xl mt-5 text-[#3d2c38]">
            كل ما تريد <span className="italic text-[#955d85]">معرفته</span>
          </h2>
