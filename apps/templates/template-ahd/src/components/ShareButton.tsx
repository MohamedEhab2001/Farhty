    ...
    <>
      <button
        ...
        style={{
          ...
          background: 'rgba(30,43,58,0.92)', backdropFilter: 'blur(8px)',
      ...
      >
        <svg viewBox="0 0 20 20" fill="none" style={{ width: '14px', height: '14px' }}>
          <path d="M13 7H7M13 7V13M13 7L7 13" stroke="#C4A35A" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        مشاركة
      </button>

      {toast && <div className="ahd-toast">تم نسخ الرابط</div>}
    </>
  )
}
