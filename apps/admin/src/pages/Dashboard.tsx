                ...
                {attentionOrders.map(o => {
                  ...
                  return (
                    <tr key={o._id}>
                      ...
                      <td className="font-mono text-xs text-[#9d8fa8] whitespace-nowrap" dir="ltr">{o.instanceSlug}.farhty.online</td>
                      <td className="text-[#9d8fa8] text-xs whitespace-nowrap">{fmt(o.createdAt)}</td>
                      <td>
                        <a href={wa} target="_blank" rel="noreferrer"
                          className="btn-gold py-1 px-3 text-xs inline-flex items-center gap-1 whitespace-nowrap">
